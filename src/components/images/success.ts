...
>
	<circle id="ring" cx="75" cy="75" r="48.5" fill="none" stroke="#186be7" stroke-width="5" transform="rotate(-90 75 75)" stroke-dasharray="400 400" stroke-dashoffset="400">
	...
	<circle id="circle" cx="75" cy="75" r="0" fill="#186be7" stroke="none">
