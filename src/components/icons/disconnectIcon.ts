...
export const disconnectIcon =(className?:string)=> svg`
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="${className || 'w-6 h-6'}">
