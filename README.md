...
```html
<script type="module">
  import {launchModal} from 'https://esm.sh/@getalby/bitcoin-connect@3.5.0'; // jsdelivr.net, skypack.dev also work

  // use Bitcoin connect API normally...
  launchModal();

  // or if you just want access to the web components:
  import 'https://esm.sh/@getalby/bitcoin-connect@3.5.0';
</script>
